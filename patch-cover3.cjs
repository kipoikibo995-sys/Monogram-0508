       ...
       <div className="w-full flex flex-col items-center mt-2 relative z-10 px-4">
          ...
          <div className="flex items-center justify-center gap-3 w-full mt-2">
            <input 
              ...
              className="text-right font-black text-[80px] outline-none w-[140px] shrink-0 min-w-0 bg-transparent bg-gradient-to-r from-orange-400 via-yellow-400 to-green-400 bg-clip-text text-transparent hover:opacity-80 transition-opacity"
              placeholder="101"
            />
            <input 
              value={parsedValue.subtitle2} 
              onChange={e => handleChange('subtitle2', e.target.value)}
              className="text-left font-black text-[56px] text-neutral-900 outline-none flex-1 min-w-0 bg-transparent hover:bg-neutral-100 focus:bg-neutral-50 tracking-tighter rounded-md transition-colors"
